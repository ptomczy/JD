...
const MILESTONES: Array<Imilestone> = [
    ...
    {name: 'Typescript poziom średni', sub: 'Zakresy zmiennych let, const, var', presub: null, adr: 'variables'},
    {name: 'Typescript poziom średni', sub: 'Typy zmiennych', presub: null, adr: 'variables'},
    ...
    {name: 'Typescript poziom średni', sub: 'Zrozumienie asynchroniczności', presub: 'Użycie przy pomocy then, catch, finally', adr: 'asynchro'},
    {name: 'Typescript poziom średni', sub: 'Zrozumienie asynchroniczności', presub: 'Użycie async i await', adr: 'asynchro'},
    {name: 'Typescript poziom średni', sub: 'Rxjs', presub: 'Tworzenie obiektów przez of, create, z promisa', adr: 'rxjs'},
    {name: 'Typescript poziom średni', sub: 'Rxjs', presub: 'Użycie w odpowiednim momencie i ubiecie subskrypcji', adr: 'rxjs'},
    {name: 'Typescript poziom średni', sub: 'Rxjs', presub: 'Użycie combinateLatest, map, switchMap, flatMap, tap, catchError', adr: 'rxjs'},
    {name: 'Typescript poziom średni', sub: 'Moment.js', presub: 'Tworzenie daty i wartości dnia, miesiąca roku itd', adr: 'moment'},
    {name: 'Typescript poziom średni', sub: 'Moment.js', presub: 'Dodawanie odejmowanie jednostek czasowych', adr: 'moment'},
    {name: 'Typescript poziom średni', sub: 'Moment.js', presub: 'Formatowanie', adr: 'moment'},
    {name: 'Typescript poziom średni', sub: 'Moment.js', presub: 'Wyciąganie różnic', adr: 'moment'},
    ...
    {name: 'Typescript poziom średni', sub: 'Angular', presub: 'Providery', adr: 'providers'},
